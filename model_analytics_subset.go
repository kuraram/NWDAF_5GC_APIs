...
type AnalyticsSubset struct {
	AnalyticsSubsetAnyOf *AnalyticsSubsetAnyOf
	string *string
}
...
func (dst *AnalyticsSubset) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into AnalyticsSubsetAnyOf
	err = json.Unmarshal(data, &dst.AnalyticsSubsetAnyOf);
	if err == nil {
		jsonAnalyticsSubsetAnyOf, _ := json.Marshal(dst.AnalyticsSubsetAnyOf)
		if string(jsonAnalyticsSubsetAnyOf) == "{}" { // empty struct
			dst.AnalyticsSubsetAnyOf = nil
		} else {
			return nil // data stored in dst.AnalyticsSubsetAnyOf, return on the first match
		}
	} else {
		dst.AnalyticsSubsetAnyOf = nil
	}
...
func (src *AnalyticsSubset) MarshalJSON() ([]byte, error) {
	if src.AnalyticsSubsetAnyOf != nil {
		return json.Marshal(&src.AnalyticsSubsetAnyOf)
	}
