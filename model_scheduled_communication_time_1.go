...
// ScheduledCommunicationTime1 struct for ScheduledCommunicationTime1
...
// SetTimeOfDayStart gets a reference to the given Object and assigns it to the TimeOfDayStart field.
...
// SetTimeOfDayEnd gets a reference to the given Object and assigns it to the TimeOfDayEnd field.
...
func (o ScheduledCommunicationTime1) MarshalJSON() ([]byte, error) {
	...
	if o.TimeOfDayStart != nil {
		toSerialize["timeOfDayStart"] = o.TimeOfDayStart
	}
	if o.TimeOfDayEnd != nil {
