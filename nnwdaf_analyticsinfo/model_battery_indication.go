...
// BatteryIndication struct for BatteryIndication
...
func (o *BatteryIndication) GetRechargeableInd() bool {
	if o == nil || o.RechargeableInd == nil {
		var ret bool
		return ret
	}
...
func (o BatteryIndication) MarshalJSON() ([]byte, error) {
	...
	if o.ReplaceableInd != nil {
		toSerialize["replaceableInd"] = o.ReplaceableInd
	}
	if o.RechargeableInd != nil {
