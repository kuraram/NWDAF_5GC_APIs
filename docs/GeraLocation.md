...
------------ | ------------- | ------------- | -------------
**LocationNumber** | Pointer to **string** | Location number within the PLMN. See 3GPP TS 23.003, clause 4.5. | [optional] 
...
**VlrNumber** | Pointer to **string** | VLR number. See 3GPP TS 23.003 clause 5.1. | [optional] 
**MscNumber** | Pointer to **string** | MSC number. See 3GPP TS 23.003 clause 5.1. | [optional] 
